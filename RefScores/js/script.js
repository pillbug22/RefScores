...
$(function(){
    ...
    $.backgroundVideo($('#bg-video'), {
        ...
        "width": 846,
        "height": 476,
        "poster": "media/baseball.png", // Change display image for video from here you want to use
        "path": "media/",        
        "filename": "baseball", // Change video from here you want to use
        "types": ["mp4"]  //prefered to have multiple types available to be available to more browsers           "types": ["mp4", "ogg", "webm"]
    });
